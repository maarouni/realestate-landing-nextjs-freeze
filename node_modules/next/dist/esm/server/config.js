...
function assignDefaults(dir, userConfig, silent) {
    var _defaultConfig_experimental, _defaultConfig_experimental1, _result_experimental, _result_experimental1, _result_experimental_serverActions, _result_experimental2, _result_experimental3, _result_turbopack, _result_turbopack1, _result_turbopack2, _result_devIndicators, _result_experimental4, _result_experimental5;
    ...
    if ((_defaultConfig_experimental1 = defaultConfig.experimental) == null ? void 0 : _defaultConfig_experimental1.dynamicIO) {
        Log.warn(`\`experimental.dynamicIO\` has been defaulted to \`true\` because \`__NEXT_EXPERIMENTAL_CACHE_COMPONENTS\` was set to \`true\` during testing.`);
    }
    const result = {
        ...defaultConfig,
        ...config,
    ...
    if (isStableBuild()) {
        ...
        } else if ((_result_experimental7 = result.experimental) == null ? void 0 : _result_experimental7.dynamicIO) {
            throw Object.defineProperty(new CanaryOnlyError({
        ...
        } else if ((_result_experimental9 = result.experimental) == null ? void 0 : _result_experimental9.nodeMiddleware) {
            throw Object.defineProperty(new CanaryOnlyError({
    ...
    if (result.experimental) {
        var _defaultConfig_experimental2, _defaultConfig_experimental_cacheLife, _defaultConfig_experimental3, _defaultConfig_experimental_staleTimes, _defaultConfig_experimental4;
        result.experimental.cacheLife = {
            ...(_defaultConfig_experimental2 = defaultConfig.experimental) == null ? void 0 : _defaultConfig_experimental2.cacheLife,
            ...result.experimental.cacheLife
        };
        const defaultDefault = (_defaultConfig_experimental3 = defaultConfig.experimental) == null ? void 0 : (_defaultConfig_experimental_cacheLife = _defaultConfig_experimental3.cacheLife) == null ? void 0 : _defaultConfig_experimental_cacheLife['default'];
        if (!defaultDefault || defaultDefault.revalidate === undefined || defaultDefault.expire === undefined || !((_defaultConfig_experimental4 = defaultConfig.experimental) == null ? void 0 : (_defaultConfig_experimental_staleTimes = _defaultConfig_experimental4.staleTimes) == null ? void 0 : _defaultConfig_experimental_staleTimes.static)) {
        ...
        if (!defaultCacheLifeProfile) {
            ...
            if (defaultCacheLifeProfile.stale === undefined) {
                var _result_experimental_staleTimes, _defaultConfig_experimental_staleTimes1, _defaultConfig_experimental5;
                ...
                defaultCacheLifeProfile.stale = staticStaleTime ?? ((_defaultConfig_experimental5 = defaultConfig.experimental) == null ? void 0 : (_defaultConfig_experimental_staleTimes1 = _defaultConfig_experimental5.staleTimes) == null ? void 0 : _defaultConfig_experimental_staleTimes1.static);
            }
        ...
        if (secondsCacheLifeProfile && secondsCacheLifeProfile.stale === undefined) {
            var _result_experimental_staleTimes1, _defaultConfig_experimental_staleTimes2, _defaultConfig_experimental6;
            ...
            secondsCacheLifeProfile.stale = dynamicStaleTime ?? ((_defaultConfig_experimental6 = defaultConfig.experimental) == null ? void 0 : (_defaultConfig_experimental_staleTimes2 = _defaultConfig_experimental6.staleTimes) == null ? void 0 : _defaultConfig_experimental_staleTimes2.dynamic);
        }
    }
...
export default async function loadConfig(phase, dir, { customConfig, rawConfig, silent = true, reportExperimentalFeatures, reactProductionProfiling, debugPrerender } = {}) {
    ...
    if (path == null ? void 0 : path.length) {
        ...
        if (userConfig.experimental && userConfig.experimental.enablePrerenderSourceMaps === undefined && userConfig.experimental.dynamicIO === true) {
            userConfig.experimental.enablePrerenderSourceMaps = true;
            addConfiguredExperimentalFeature(configuredExperimentalFeatures, 'enablePrerenderSourceMaps', true, 'enabled by `experimental.dynamicIO`');
        }
        if (debugPrerender && (phase === PHASE_PRODUCTION_BUILD || phase === PHASE_EXPORT)) {
            userConfig.experimental ??= {};
            setExperimentalFeatureForDebugPrerender(userConfig.experimental, 'serverSourceMaps', true, reportExperimentalFeatures ? configuredExperimentalFeatures : undefined);
            setExperimentalFeatureForDebugPrerender(userConfig.experimental, process.env.TURBOPACK ? 'turbopackMinify' : 'serverMinification', false, reportExperimentalFeatures ? configuredExperimentalFeatures : undefined);
            setExperimentalFeatureForDebugPrerender(userConfig.experimental, 'enablePrerenderSourceMaps', true, reportExperimentalFeatures ? configuredExperimentalFeatures : undefined);
            setExperimentalFeatureForDebugPrerender(userConfig.experimental, 'prerenderEarlyExit', false, reportExperimentalFeatures ? configuredExperimentalFeatures : undefined);
        }
...
export function addConfiguredExperimentalFeature(configuredExperimentalFeatures, key, value, reason) {
